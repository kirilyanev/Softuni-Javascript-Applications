...
import { getById, editBook } from '../data/books.js';
    ...
    <section id="edit-page" class="edit">
        <form id="edit-form" action="#" method="" @submit=${onEdit}>
            <fieldset>
                ...
                <input class="button submit" type="submit" value="Save" @submit=${editBook}>
            </fieldset>
        </form>
    </section>`;
